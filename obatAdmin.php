      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-body">
                <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addModal">Tambah Obat</button>
                <br></br>  
                    ...
                    foreach ($obatData as $obatRow) {
                      ...
                      echo "<td>
                                                <form method='post' action=''>
                                                    ...
                                                    <button type='button' name='update_obat' class='btn btn-success btn-sm update-btn' data-toggle='modal' data-target='#updateModal' 
                                                    data-id='" . $obatRow['id'] . "' 
                                                    ...
                                                    <form method='post' action=''>
                                                        <input type='hidden' name='id' value='" . $obatRow['id'] . "'>
                                                        <button type='submit' name='delete_obat' class='btn btn-danger btn-sm' onclick='return confirm(\"Apakah yakin ingin dihapus ?\");'>Hapus</button>
                                                    </form>
                                                </form>
                                            </td>";
                      echo "</tr>";
