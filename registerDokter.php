...
<div class="container mt-4">
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card">
                <div class="card-header text-center" style="font-size: 32px;"><b>Registrasi </b>Dokter</div>
                <div class="card-body">
                    ...
                    <div class="text-center">
                        <p class="mt-3">Sudah Punya Akun? <a href="index.php?page=loginDokter"><b>Login</b></a></p>
                    </div>
                </div>
            </div>
        </div>
