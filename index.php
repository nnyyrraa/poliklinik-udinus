...
<body style="background-color: #e9ecef;">
    <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #414C66;">
    ...
    if (isset($_GET['page'])) {
        ...
        echo "<br><h2>&ensp;Selamat Datang di Poliklinik Udinus";

        if (isset($_SESSION['username' . 'nama'])) {
            // jika sudah login tampilkan username
            echo ", " . $_SESSION['username' . 'nama'] . "</h2><hr>";
        } else {
            echo "</h2><hr>&ensp;&ensp;Login terlebih dahulu untuk menggunakan sistem. Jika anda belum memiliki akun silakan registrasi terlebih dahulu.";
        }
    }
    ?>
</body>
